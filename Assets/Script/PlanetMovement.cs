...
public class PlanetMovement : MonoBehaviour {
	...
	void TargetHesapla(){
		...
		if (playerArray[0].cekimTusuBasildiMi == false && playerArray[1].cekimTusuBasildiMi == false && playerArray[2].cekimTusuBasildiMi == false && playerArray[3].cekimTusuBasildiMi == false) {
			target = new Vector3(0,0,transform.position.z);
		}
		else{
